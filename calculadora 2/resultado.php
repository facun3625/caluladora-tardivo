...
$operacion12 = $operacion1b + $operacion2b + $operacion3b + $operacion4b + $operacion7b + $operacion9b + $operacion10b + $operacion11b + $operacion13b;
$operacion14 = sprintf('%.2f', $operacion12);
?>
        
        
        Art. 245 L.C.T. (Antigüedad): $ <?php echo $operacion1b ?><br />
        Art. 232 L.C.T.  (Preaviso): $ <?php echo $operacion2b ?><br />
        ...
        SAC sobre Preaviso: $ <?php echo $operacion13b ?><br />
