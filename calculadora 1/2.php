...
<form id="form1" name="form1" method="post" action="resultado_trabajo.php">
  <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td width="200" align="center"><a href="2.php" class="button">En el lugar de tabajo</a></td>
  ...
  <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td colspan="2" align="center"><a href="2_44.php" class="button2">Igual o menor al 50%</a></td>
    </tr>
    <tr>
      <td colspan="2" align="center">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="2" align="center"> <a href="2_55.php" class="button2">Es mayor a 50% pero menor a 66%</a></td>
    </tr>
    <tr>
      <td colspan="2" align="center">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="2" align="center"><a href="2_70.php" class="button2">Es igual o mayor a 66%</a></td>
    </tr>
    <tr>
      <td width="200">&nbsp;</td>
      <td width="190">&nbsp;</td>
