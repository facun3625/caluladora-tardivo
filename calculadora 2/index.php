...
<form id="form1" name="form1" method="post" action="resultado_trabajo.php">
  <table width="400" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td width="200" align="center"><a href="1.php" class="button is-outline is-small mb-0">Con Preaviso</a></td>
      <td width="200" align="center"><a href="1_b.php" class="button is-outline is-small mb-0">Sin Preaviso</a></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
